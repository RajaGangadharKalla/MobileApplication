...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 20, 2021 at 10:21 PM
...
INSERT INTO `adminprofile` (`name`, `nickname`, `address`, `phone`) VALUES
('example', 'example', 'address', 213456),
('qwerwe', 'werqwe', 'qweqwe', 1234);
